...
![Add Keystore](https://github.com/TimWaeckerle/KeyFortress/assets/97874901/813928a4-3a50-4b9c-82a6-b35b96f27d5f)
...
### Keystore View
Inside the keystore view, you'll see your keystore entries. If you've just created a keystore, there will be no entries yet. The programm titles shows you, which keystore is opened.
...
Your data will be persisted locally on the file system, so your information will remain accessible even after you close the program.
